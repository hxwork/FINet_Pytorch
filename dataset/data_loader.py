...
class ModelNetNpy(Dataset):
    ...
    def __getitem__(self, item):
        ...
        data_path = os.path.join("/data/code/meg_brain_mine", data_path)
...
def fetch_dataloader(params):
    ...
    if params.dataset_type == "modelnet_os":
        ...
        train_categories = [line.rstrip("\n") for line in open("/data/code/meg_brain_mine/dataset/data/modelnet40_half1_rm_rotate.txt")]
        val_categories = [line.rstrip("\n") for line in open("/data/code/meg_brain_mine/dataset/data/modelnet40_half1_rm_rotate.txt")]
        test_categories = [line.rstrip("\n") for line in open("/data/code/meg_brain_mine/dataset/data/modelnet40_half2_rm_rotate.txt")]
